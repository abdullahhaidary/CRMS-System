...
@section('content')
    ...
    <div class="container mt-0">
        <form id="finger_form" method="POST" action="{{ route('store_finger_print_criminal') }}">
            @csrf
        ...
        <main role="main" class="pb-3">
            <div class="row">
                <div class="col-md-10">
                    ...
                    <div class="row">
                        <div class="col-12 justify-content-between d-flex flex-row">
                            <div class="p-5 d-flex flex-column">
                                <div>
                                    <i onclick="captureFP(1)" id="1" class="fas fa-fingerprint"
                                        style="font-size:40pt;cursor:pointer"></i>
                                </div>
                                <div>
                                    <p>Left Thumb</p>
                                </div>
                            ...
                            <div class="p-5 d-flex flex-column">
                                <div>
                                    <i onclick="captureFP(2)" id="2" class="fas fa-fingerprint"
                                        style="font-size:40pt;cursor:pointer"></i>
                                </div>
                                <div>
                                    <p>Left Index</p>
                            ...
                            <div class="p-5 d-flex flex-column">
                                <div>
                                    <i onclick="captureFP(3)" id="3" class="fas fa-fingerprint"
                                        style="font-size:40pt;cursor:pointer"></i>
                                </div>
                                <div>
                                    <p>Right Thumb</p>
                            ...
                            <div class="p-5 d-flex flex-column">
                                <div>
                                    <i onclick="captureFP(4)" id="4" class="fas fa-fingerprint"
                                        style="font-size:40pt;cursor:pointer"></i>
                                </div>
                                <div>
                                    <p>Right Index</p>
                    ...
                    <button type="submit" onclick="document.getElementById('finger_form').submit()"
